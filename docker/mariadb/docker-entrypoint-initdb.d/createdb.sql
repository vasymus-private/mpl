...
CREATE DATABASE IF NOT EXISTS `mpl` COLLATE 'utf8mb4_unicode_ci' ;
GRANT ALL ON `mpl`.* TO 'default'@'%' ;

CREATE DATABASE IF NOT EXISTS `mpl_test` COLLATE 'utf8mb4_unicode_ci' ;
GRANT ALL ON `mpl_test`.* TO 'default'@'%' ;
