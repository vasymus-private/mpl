...
<template>
    ...
    >
        <NavItem
            :id-or-href="routesStore.route(routeNames.ROUTE_ADMIN_PRODUCTS_TEMP_INDEX, {product_type: props.product_type})"
            title="Товары"
        ...
        >
            <NavItem
                :id-or-href="routesStore.route(routeNames.ROUTE_ADMIN_PRODUCTS_TEMP_INDEX, {product_type: props.product_type, category_id : category.id})"
                title="Товары"
                :is-inertia-link="true"
                :is-collapse="false"
                icon-class="adm-arrow-icon-dot"
            ...
            >
                <NavItem
                    :id-or-href="routesStore.route(routeNames.ROUTE_ADMIN_PRODUCTS_TEMP_INDEX, {product_type: props.product_type, category_id : subcategory1.id})"
                    title="Товары"
                    :is-inertia-link="true"
                    :is-collapse="false"
                    icon-class="adm-arrow-icon-dot"
                ...
                >
                    <NavItem
                        :id-or-href="routesStore.route(routeNames.ROUTE_ADMIN_PRODUCTS_TEMP_INDEX, {product_type: props.product_type, category_id : subcategory2.id})"
                        title="Товары"
                        :is-inertia-link="true"
                        :is-collapse="false"
                        icon-class="adm-arrow-icon-dot"
                    ...
                    >
                        <NavItem
                            :id-or-href="routesStore.route(routeNames.ROUTE_ADMIN_PRODUCTS_TEMP_INDEX, {product_type: props.product_type, category_id : subcategory3.id})"
                            title="Товары"
                            :is-inertia-link="true"
                            :is-collapse="false"
                            icon-class="adm-arrow-icon-dot"
