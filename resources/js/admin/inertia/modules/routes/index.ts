...
export const routeNames = {
    ...
    ROUTE_ADMIN_AJAX_GALLERY_ITEMS_BULK_UPDATE: 'admin-ajax.gallery-item.bulk.update',
    ROUTE_ADMIN_AJAX_GALLERY_ITEMS_BULK_DELETE: 'admin-ajax.gallery-item.bulk.delete',
