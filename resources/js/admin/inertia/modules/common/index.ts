...
export const extendMetaLinksWithComputedData = (meta: Meta, fullUrl: string|null): Meta => {
...
export const extendUrlWithCurrentParams = (url: string|null, fullUrl: string|null): string|null => {
    if (!url) {
        return null
    }
