...
export const useIndexProductsFormStore = defineStore(storeName, {
    actions: {
        ...
        ): SubmissionHandler<{ products: Array<Partial<ProductListItem>> }> {
            return async (values: Values, { setErrors, ...restActions }) => {
                ...
                try {
                    ...
                    const {
                        ...
                        {
                            products: productsToUpdate.reduce(
                                (acc, item) => ({
                                    ...acc,
                                    [item.id]: item,
                                }),
...
export const getIndexForIdCb = (values: Values) => (id: number) =>
