...
export const getCartColumnCountPartNormals$ = () => jQuery(`.js-cart-column-count-part-normal`)
export const getCartColumnCountPartNormal$ = id => getCartColumnCountPartNormals$().filter(`[data-id=${id}]`)

export const getCartColumnCountPartDeleteds$ = () => jQuery(`.js-cart-column-count-part-deleted`)
export const getCartColumnCountPartDeleted$ = id => getCartColumnCountPartDeleteds$().filter(`[data-id=${id}]`)
...
export const getCartItemSumFormatted$ = (id) => jQuery(`.js-cart-item-sum-formatted`).filter(`[data-id=${id}]`)
