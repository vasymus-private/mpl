...
<div class="row">
    ...
    <div class="btn-group" role="group" aria-label="actions">
        ...
        <button onclick="if (confirm('Вы уверены, что хотите удалить отмеченные записи?')) {@this.handleDeleteSelectedVariations();}" aria-label="delete all" type="button" class="btn btn-light" @if(!$this->anyVariationChecked) disabled @endif><i class="fa fa-times" aria-hidden="true"></i></button>
    </div>
    @else
