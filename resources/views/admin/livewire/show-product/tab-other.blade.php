    ...
    <div class="row-line">
        ...
        <div class="column">
            @foreach($categories as $category)
                <div wire:key="other-tab-category-{{$category['value']}}" class="other-page__item">
                    <div class="form-check form-check-inline">
                        ...
                        <label for="related-category-{{$category['value']}}" class="custom-checkbox">
                            <input wire:model.defer="relatedCategories" name="relatedCategories[]" class="form-check-input" type="checkbox" value="{{$category['value']}}" id="related-category-{{$category['value']}}" />
