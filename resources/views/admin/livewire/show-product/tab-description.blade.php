<div class="item-edit product-edit">
    <div class="form-group">
        <label for="item.preview">Описание для анонса</label>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade" id="preview-html" role="tabpanel" aria-labelledby="preview-html-tab" style="height: 600px">
                @include('admin.livewire.includes.form-control-textarea', ['field' => 'item.preview', 'class' => 'h-100'])
            </div>
            <div class="tab-pane fade show active" id="preview-editor" role="tabpanel" aria-labelledby="preview-editor-tab">
                <textarea id="item-preview-tinymce" rows="10" cols="80"></textarea>
                @error('item.preview') <div class="invalid-feedback">{{ $message }}</div> @enderror
            </div>
        </div>
    </div>

    <div class="form-group">
        <label for="item.description">Детальное описание</label>
        <div class="nav nav-tabs" role="tablist">
