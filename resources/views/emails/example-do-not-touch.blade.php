...
@section('content')
    ...
    <p>Пожалуйста, при обращении к администрации сайта parket-lux.ru ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - 9491. Связаться с менеджером можно по телефону: {{Support\H::getPhone1()}}.</p>
