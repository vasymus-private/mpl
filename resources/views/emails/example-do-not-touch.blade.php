...
@section('content')
    ...
    <p>Пожалуйста, при обращении к администрации сайта market-parket.ru ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - 9491. Связаться с менеджером можно по телефону: {{SupportSupport\H::getPhone1()}}.</p>
