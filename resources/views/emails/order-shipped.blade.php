...
@section('content')
    ...
    @endif
    <p>Пожалуйста, при обращении к администрации сайта {{SupportSupport\H::website()}} ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - <b>{{$order->id}}</b>. Связаться с менеджером можно по телефону: {{SupportSupport\H::getPhone1()}}.</p>
    <p>Спасибо за покупку!</p>
    <p>
        С уважением,<br/>
        администрация <a href="{{route('home')}}">Интернет-магазина</a> <br/>
        E-mail: {{SupportSupport\H::getMail()}}
    </p>
@endsection
