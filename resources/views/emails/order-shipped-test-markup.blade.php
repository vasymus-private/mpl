...
@section('content')
    ...
    <p>Пожалуйста, при обращении к администрации сайта {{SupportSupport\H::website()}} ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - <b>9491</b>. Связаться с менеджером можно по телефону: {{SupportSupport\H::getPhone1()}}.</p>
