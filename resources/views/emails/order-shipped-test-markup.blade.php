...
@section('content')
    ...
    <p>Пожалуйста, при обращении к администрации сайта union.parket-lux ОБЯЗАТЕЛЬНО указывайте номер Вашего заказа - <b>9491</b>. Связаться с менеджером можно по телефону: <a href="">+7(495) 760-05-18</a>.</p>
