        ...
        <ul class="photo-gallery-wrapper__list">
            @foreach($galleryItems as $index => $galleryItem)
                ...
                <li class="photo-gallery-wrapper__item">
                    ...
                    <div class="photo-gallery-wrapper__img-block"><img src="{{$galleryItem->getFirstMediaUrl(\App\Models\GalleryItem::MC_MAIN_IMAGE)}}" alt="{{$galleryItem->name}}" title="{{$galleryItem->description}}" width="150" height="110" /></div>
