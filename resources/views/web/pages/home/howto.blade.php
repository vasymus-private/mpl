...
@section('page-content')
    <div class="content content">
        ...
        <div class="single">
            ...
            <div class="single">
                <p>
                    1. Положите понравившиеся товары в "<span style="font-size: 11pt;">корзину</span>" в нужном
                    количестве.
                </p>
                <p>
                ...
                <p>
                    Просмотренные товары останутся в блоке «<span style="color: #0054a5;"><b><a href="{{asset("images/howto/b04119ad376b9c6ee92e69700414ef17.png")}}" data-caption="ФОТО ВЫ СМОТРЕЛИ"><span style="color: #0054a5;">Вы смотрели</span></a></b></span>», можно быстро к ним вернуться.
                </p>
                <p>
                    Понравившиеся товары можно поместить в раздел «<span style="color: #0054a5;"><b><a href="{{asset("images/howto/9e76391148057415491c60a1e12c4c87.png")}}" data-caption="ФОТО ОТЛОЖЕНО"><span style="color: #0054a5;">Отложенные товары</span></a></b></span>».
                </p>
                <p>
                ...
                <p>
                    3. Закончив покупки, перейдите на страницу&nbsp;«<span style="font-size: 11pt;">Корзина</span>» для
                    проверки и оформления заказа.
                </p>
                <p>
                ...
                <p>
                    1. Перейдите на страницу&nbsp;<span style="color: #262626; font-size: 12pt;">«</span><span
                        style="color: #262626;"><span style="font-size: 11pt;">Корзина</span></span>».
                </p>
                <p>
                ...
                <p>
                    &nbsp; &nbsp; в) для выставления счета по безналу, прикрепите файл с реквизитами организации.
                </p>
                <p>
