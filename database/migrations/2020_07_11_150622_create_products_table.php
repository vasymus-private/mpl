...
class CreateProductsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->tinyInteger('ch_compatibility_wood_usual_rate')->nullable();
            $table->tinyInteger('ch_compatibility_wood_exotic_rate')->nullable();
            $table->tinyInteger('ch_compatibility_wood_cork_rate')->nullable();
            $table->tinyInteger('ch_suitability_parquet_piece_rate')->nullable();
            $table->tinyInteger('ch_suitability_parquet_massive_board_rate')->nullable();
            $table->tinyInteger('ch_suitability_parquet_board_rate')->nullable();
            $table->tinyInteger('ch_suitability_parquet_art_rate')->nullable();
            $table->tinyInteger('ch_suitability_parquet_laminate_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_living_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_office_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_restaurant_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_child_and_medical_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_gym_rate')->nullable();
            $table->tinyInteger('ch_suitability_placement_industrial_zone_rate')->nullable();
            $table->tinyInteger('ch_exploitation_abrasion_resistance_rate')->nullable();
            $table->tinyInteger('ch_exploitation_surface_firmness_rate')->nullable();
            $table->tinyInteger('ch_exploitation_elasticity_rate')->nullable();
            $table->tinyInteger('ch_exploitation_sustain_uv_rays_rate')->nullable();
            $table->tinyInteger('ch_exploitation_sustain_chemicals_rate')->nullable();
