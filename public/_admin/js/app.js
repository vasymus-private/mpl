...
try {
  ...
  __webpack_require__(/*! @fancyapps/fancybox */ "./node_modules/@fancyapps/fancybox/dist/jquery.fancybox.js"); // require('bootstrap');
...
/***/ "./resources/js/admin/modules/ckeditor4.js":
/*!*************************************************!*\
  !*** ./resources/js/admin/modules/ckeditor4.js ***!
  \*************************************************/
/***/ (() => {
...
(function () {
  ...
  window.livewireCkeditor4 = function () {
    var selectors = [{
    ...
    selectors.forEach(function (_ref) {
      ...
      if (!jQuery("#".concat(editorId)).length) {
        return true;
      }
      ...
      var editor = window.___editors[editorId] = CKEDITOR.replace(editorId, options);
      editor.setData(document.getElementById(sourceId).value);
...
/***/ "./resources/js/admin/modules/footerSticky.js":
/*!****************************************************!*\
  !*** ./resources/js/admin/modules/footerSticky.js ***!
  \****************************************************/
/***/ (() => {
...
(function () {
  var wrapperSelector = ".js-edit-footer-wrapper";
  var footerSelector = ".js-edit-item-footer";
  var fixedClass = "edit-item-footer-fixed";
  var pinButtonSelector = ".js-pin-btn";
  var pinButtonPinnedClass = "pin-btn-pinned";
  var footerMarkerSelector = ".js-edit-item-footer-marker";
  var $window = $(window);
  var $wrappers = $(wrapperSelector);
  $wrappers.each(function (i, el) {
    var $wrapper = $(el);
    var $btn = $wrapper.find(pinButtonSelector);
    var $footer = $wrapper.find(footerSelector);
    var $maker = $wrapper.find(footerMarkerSelector);
    var isPinned = true;
    ...
    function getIsVisible() {
      var footerTop = $maker.offset().top;
      var scrollTop = $window.scrollTop();
      var space = $window.height() - $footer.height();
      var compare = scrollTop + space + 20;
...
/***/ "./resources/js/admin/modules/navTabsSticky.js":
/*!*****************************************************!*\
  !*** ./resources/js/admin/modules/navTabsSticky.js ***!
  \*****************************************************/
/***/ (() => {
...
(function () {
  var wrapperSelector = ".js-nav-tabs-wrapper";
  var navSelector = ".js-nav-tabs";
  var markerSelector = ".js-nav-tabs-marker";
  var fixedClass = "nav-tabs-fixed";
  var $window = $(window);
  var $wrappers = $(wrapperSelector);
  $wrappers.each(function (i, el) {
    var $wrapper = $(el);
    var $nav = $wrapper.find(navSelector);
    var $marker = $wrapper.find(markerSelector);
    main();
    $('[data-toggle="tab"]').on("shown.bs.tab", function () {
      main();
    });
...
/***/ "./resources/js/admin/modules/orderBusy.js":
/*!*************************************************!*\
  !*** ./resources/js/admin/modules/orderBusy.js ***!
  \*************************************************/
...
(function () {
  ...
  function handleMarkers() {
    var isBusyHtml = "<span style=\"display: inline-block; width: 20px; height: 20px; background-color: red; border-radius: 100%;\"></span>";
    var isNotBusyHtml = "<span style=\"display: inline-block; width: 20px; height: 20px; background-color: green; border-radius: 100%;\"></span>";
    setInterval(function () {
      console.log("--- sync order busy markers ---");
      var $orderBusyMarkerWrapper = $(".js-order-busy-marker-wrapper");

      if (!$orderBusyMarkerWrapper.length) {
        return;
      }

      var $markers = $orderBusyMarkerWrapper.find(".js-order-busy-marker");
      var ids = [];
      ...
      _helpers_Rest__WEBPACK_IMPORTED_MODULE_0__["default"].POST("/admin-ajax/show-order-busy", {
        ids: ids
      }).then(_helpers_Rest__WEBPACK_IMPORTED_MODULE_0__["default"].middleThen).then(function (response) {
        ...
        data.forEach(function (item) {
          var id = item.id,
              is_busy_by_other_admin = item.is_busy_by_other_admin;
          var $marker = $orderBusyMarkerWrapper.find(".js-order-busy-marker-".concat(id));
  ...
  window.handlePingOrderBusy = function (id) {
    pingOrderBusy(id);
    setInterval(function () {
      pingOrderBusy(id);
    }, 30 * 1000);
  ...
  function pingOrderBusy(id) {
    ...
    _helpers_Rest__WEBPACK_IMPORTED_MODULE_0__["default"].POST("/admin-ajax/ping-order-busy/".concat(id)).then(_helpers_Rest__WEBPACK_IMPORTED_MODULE_0__["default"].middleThen)["catch"](_helpers_Rest__WEBPACK_IMPORTED_MODULE_0__["default"].simpleCatch);
  }
})();
...
/***/ "./resources/js/admin/modules/sortColumns.js":
/*!***************************************************!*\
  !*** ./resources/js/admin/modules/sortColumns.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
Object(function webpackMissingModule() { var e = new Error("Cannot find module 'sortablejs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
function init(id) {
  ...
  new Object(function webpackMissingModule() { var e = new Error("Cannot find module 'sortablejs'"); e.code = 'MODULE_NOT_FOUND'; throw e; }())(document.getElementById(id), {
    animation: 150,
...
(function ($) {
  $(function () {
    ...
    __webpack_require__(/*! ./modules/ckeditor4 */ "./resources/js/admin/modules/ckeditor4.js");

    __webpack_require__(/*! ./modules/sidebar */ "./resources/js/admin/modules/sidebar.js");

    __webpack_require__(/*! ./modules/orderBusy */ "./resources/js/admin/modules/orderBusy.js");
    ...
    __webpack_require__(/*! ./modules/footerSticky */ "./resources/js/admin/modules/footerSticky.js");
  });
})(jQuery);
...
__webpack_require__(/*! ./root */ "./resources/js/admin/root.js");
})();
